...
#ifndef __NSRD_PQUEUE_HEAP_H__
#define __NSRD_PQUEUE_HEAP_H__
...
/*
DESCRIPTION
    Frees the memory allocated for each element of the priority queue and the
    queue itself. All data inside the queue will be lost.
RETURN
...
/*
DESCRIPTION
    Get data from highest priority element. Data is stored in priority queue
    by reference. Trying to peek empty priority queue is undefined behavior.
RETURN
