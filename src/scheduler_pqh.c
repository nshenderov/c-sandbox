/*******************************************************************************
*
*  FILENAME : scheduler_pqh.c
*
* DESCRIPTION : Scheduler implementation using pqueue-heap container.
* 
                            ...
                            size_t interval_seconds)
{
    ...
    new_task = TaskCreate((task_action_t) action, (task_clean_func_t) cleanup,
                               action_params, cleanup_params, interval_seconds);
